      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            🛠️ Hands-on practice and ✨ small wins have shaped the way I learn and grow as a developer 👨‍💻📈
              <br />
              ...
              <br />
              <br />
              🛠 I’m currently sharpening my <b className="purple">backend skills</b> with
              <i>
                <b className="purple">
                  {" "}
                  Express.js
